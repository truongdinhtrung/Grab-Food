...
export default function Bottom(){
    return(
        <>
           <div className='h-[480px] bg-lime-500 '>
                <div className='ml-[130px]'>
                     <button className=' pt-16  text-3xl md:flex items-center px-3 font-bold text-white mb-10  '>
                         GrabFood
                     </button>
                     <div className='text-white'>
                    --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                    <div className='flex mt-5 '>
                        <button className='text-lg mr-[150px]'>Về GrabFood</button>
                       <button className='text-lg mr-[150px]'>Mở quán trên GrabFood    </button>
                       <button className='text-lg mr-[150px]'  >Trung tâm hỗ trợ</button>
                       <button><FaFacebookSquare size={30} className='mr-5' /> </button>
                       <button><FaInstagram size={30} className='mr-5' /></button>
                       <button> <FaTwitterSquare size={30} className='mr-5' /></button>
                     </div>
                     <div className='flex mt-5'>
                       <button className='text-lg mr-[190px]'>Về Grab</button>
                       <button className='text-lg mr-[180px]'>Trở thành tài xế Grab   </button>
                       <button className='text-lg'  >Câu hỏi thường gặp</button>
                     </div> 
                     <button className='text-lg mt-5 mb-10'>Blog</button>
                     </div>
                     <div className='text-white  '>
                     --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
                     <div className=' flex items-center mt-8'>
                         <button className=' bg-black rounded py-1 pr-[20px] flex'>
